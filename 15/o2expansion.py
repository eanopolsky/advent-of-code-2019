...
if __name__ == "__main__":
    ...
    while len(unexploredspace) > 0:
        ...
        unexploredspace = [maptile for maptile in areamap
                           ...
                           maptile["content"] != "#"]
    #print(areamap)
    areaswithgas = [maptile for maptile in areamap if maptile["content"] != "#"]
    areaswithgas.sort(key=lambda maptile: maptile["minmoves"], reverse=True)
    print("minutes to O2 refill: {}".format(areaswithgas[0]["minmoves"]))
